...
public class BResourceIT {
    ...
    public void createB() throws Exception {
        ...
        // Create the B
        restBMockMvc
            .perform(post("/api/bs").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(b)))
    ...
    public void getAllBS() throws Exception {
        ...
        // Get all the bList
        restBMockMvc
            .perform(get("/api/bs?sort=id,desc"))
    ...
    public void getNonExistingB() throws Exception {
        // Get the b
        restBMockMvc.perform(get("/api/bs/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateB() throws Exception {
        ...
        restBMockMvc
            .perform(put("/api/bs").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedB)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingB() throws Exception {
        ...
        restBMockMvc
            .perform(put("/api/bs").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(b)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteB() throws Exception {
        ...
        // Delete the b
        restBMockMvc.perform(delete("/api/bs/{id}", b.getId()).accept(MediaType.APPLICATION_JSON)).andExpect(status().isNoContent());
