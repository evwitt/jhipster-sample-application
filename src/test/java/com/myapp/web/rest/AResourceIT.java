...
public class AResourceIT {
    ...
    public void createA() throws Exception {
        ...
        // Create the A
        restAMockMvc
            .perform(post("/api/as").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(a)))
    ...
    public void getAllAS() throws Exception {
        ...
        // Get all the aList
        restAMockMvc
            .perform(get("/api/as?sort=id,desc"))
    ...
    public void getNonExistingA() throws Exception {
        // Get the a
        restAMockMvc.perform(get("/api/as/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateA() throws Exception {
        ...
        restAMockMvc
            .perform(put("/api/as").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedA)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingA() throws Exception {
        ...
        restAMockMvc
            .perform(put("/api/as").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(a)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteA() throws Exception {
        ...
        // Delete the a
        restAMockMvc.perform(delete("/api/as/{id}", a.getId()).accept(MediaType.APPLICATION_JSON)).andExpect(status().isNoContent());
