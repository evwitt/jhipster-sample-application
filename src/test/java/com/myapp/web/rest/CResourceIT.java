...
public class CResourceIT {
    ...
    public void createC() throws Exception {
        ...
        // Create the C
        restCMockMvc
            .perform(post("/api/cs").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(c)))
    ...
    public void getAllCS() throws Exception {
        ...
        // Get all the cList
        restCMockMvc
            .perform(get("/api/cs?sort=id,desc"))
    ...
    public void getNonExistingC() throws Exception {
        // Get the c
        restCMockMvc.perform(get("/api/cs/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateC() throws Exception {
        ...
        restCMockMvc
            .perform(put("/api/cs").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedC)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingC() throws Exception {
        ...
        restCMockMvc
            .perform(put("/api/cs").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(c)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteC() throws Exception {
        ...
        // Delete the c
        restCMockMvc.perform(delete("/api/cs/{id}", c.getId()).accept(MediaType.APPLICATION_JSON)).andExpect(status().isNoContent());
